...
require_relative "lib/track_progress/version"

Gem::Specification.new do |spec|
  spec.name = "track_progress"
  spec.version = TrackProgress::VERSION
  spec.authors = ["Daniel Enriquez"]
  spec.email = ["daniel.enm17@gmail.com"]
